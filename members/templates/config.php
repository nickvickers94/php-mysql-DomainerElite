...
/*  GENERAL SETTING  */
	...
	$author = 'Domainer Elite'; // for author meta data: <meta name="author" content="$author; ">
	$website_name = 'Domainer Elite'; // for closing title every page: <title>$title;  | $website_name;</title> 
	$footer_message = 'Copyright &copy;2015 Domainer Elite. All Rights Reserved'; // Set Copyright message on footer
	$logo_path = 'img/logo.png';	
	$background = 'background-3'; // '' = none, or 'background-login', 'vd_bg-grey', 'background-1' until 'background-8' or create your own background css	
...
/*  HEADER AND FOOTER SETTING  */
	...
	$header = 'header-2'; // 'header-1' or 'header-2' or 'header-3' or 'header-4' ,or other 'header-*' located at templates/headers/$header.tpl.php	
...
/*  LEFT SIDEBAR NAVIGATION SETTING  */
	...
	$navbar_left = 'navbar-no-tab'; // 'navbar-tabs-menu' or 'navbar-tabs-profile' or 'navbar-tabs-tab' or 'navbar-email' or 'navbar-chat' or 'navbar-no-tab'
...
/*  SIDEBAR MENU TOGGLE BUTTON SETTING  */
	...
	$medium_nav_toggle = 0; // visibility of change sidebar menu width from large to medium button: 1= visible, 0 = none
	$small_nav_toggle = 0; // visibility of change sidebar menu width from large to small or medium to small button: 1= visible, 0 = none
...
/*  EXTRA CLASS SETTING  */	
	...
	$top_menu_extra_class = 'vd_bg-black';  // background class such as 'vd_bg-white', also 'light-top-menu', 'menu-search-style-2'	
