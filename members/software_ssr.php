...
<head>
  ...
  padding: 0 11px 0px 10px;
    ...
    <style>
		...
		.customScrollBox {
  background: url("images/godaddy.png") no-repeat scroll left 30px;
  height: 200px;
  margin: 8px 7px -8px;
}
.search_results_clickbank > a {
                                                                                        ...
                                                                                        <div id="mcs_container">
                                                                                            <div class="customScrollBox">
                                                                                                <div class="container" style="">
                                                                                                    <div class="content">
                                                                                                        <table border="0" width="100%">
                                                                                                            <tr>
                                                                                                                <td align="left" class="search_results_clickbank" ><a href="#">Potential Domains with Appraisals</a>
                                                                                                                </td>
                                                                                                ...
                                                                                                <div class="dragger_container">
                                                                                                    <div class="dragger ui-draggable" style="display: block; height: 0px; line-height: 0px; top: 0px;"></div>
                                                                                                </div>
                                                                                            </div>
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tr>
                                                                                    <td width="67" align="left" valign="top">
                                                                                        <a href="#" title="Click Here" id="btnplus"><img src="images/plus.png" /> 
                                                                                        </a>
                                                                                        <a href="#" id="btnminus"><img src="images/minus.png" />
                                                                                        </a>
                                                                                    </td>
                                                                                    <td align="left" valign="top">
	...
	*/
        ...
        jQuery(document).ready(function(e) {
            ...
            jQuery("#btnplus").on("click", function(e) {
                ...
                jQuery("#results_loading").html("<span><img src='images/103.gif' border='0'></span>");
