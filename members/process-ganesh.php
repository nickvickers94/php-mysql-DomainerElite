...
if($option==1 || $option==2 || $option==3){
	...
	$data = getHTML("https://godaddy.com/domainsapi/v1/search/exact?q=".$keyword.".".$extention."&key=dpp_search&pc=&ptl=",6000);
	...
	$data = getHTML("https://godaddy.com/domainsapi/v1/search/exact?q=".$domain."&key=dpp_search&pc=&ptl=",6000);
	...
	if($data_decoded!="" || $data_decoded!=NULL){
		...
		if($available==1001 || $purchaseable==true){
