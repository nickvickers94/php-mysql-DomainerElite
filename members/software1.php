...
<?php 
	if ($_SESSION['software_pro'] == 'N') {
		header("Location: http://www.domainerelite.com/pro/"); 
		exit;
											...
											<div class="group" style="width: 50%;">
												...
												<div class="dropdown">
													...
													<ul class="dropdown-menu">
														...
														<?php $arr_extensions = explode(",", str_replace(" ", "", $lists["extensions"])); ?>



														<?php foreach ($arr_extensions as $extension): ?>



															<li class="dropdown-item"><a tabindex="1">.<?php echo($extension); ?></a></li>
