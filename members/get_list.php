...
<tr>
   <td>&nbsp;</td>
   <td><a id="lnkdomain1" class="a" onclick="selectDomain('<?php echo strtolower($ed); ?>');">Select</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="lnkdomain1" class="a" onclick="rank('<?php echo strtolower($ed); ?>','expired_domains');$(this).text('You Voted!');">Vote</a></td>
</tr>
<?php
   $rank++;
   }     
...
<tr>
   <td>&nbsp;</td>
   <td><a id="lnkdomain1" class="a" onclick="selectDomain('<?php echo strtolower($jd); ?>');">Select</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="lnkdomain1" class="a" onclick="rank('<?php echo strtolower($jd); ?>','jamies_domains');$(this).text('You Voted!');">Vote</a></td>
</tr>
<?php
   $rank++;
   }     
...
<tr>
   <td>&nbsp;</td>
   <td><a id="lnkdomain1" class="a" onclick="selectDomain('<?php echo strtolower($dd); ?>');">Select</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="lnkdomain1" class="a" onclick="rank('<?php echo strtolower($dd); ?>','dictionary_domains');$(this).text('You Voted!');">Vote</a></td>
</tr>
<?php
$rank++;
}     
