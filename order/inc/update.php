...
$transactionid = '2810837533';
$firstname = 'abderrahim';
$lastname = 'Kajouj';
$gw->doUpdate($transactionid, $firstname, $lastname);
class gwapi {
...
// Initial Setting Functions
  ...
  function doTrial($amount, $plan_amount, $plan_payments, $day_frequency, $ccnumber, $ccexp, $cvv="") {
  ...
  function doUpdate($transactionid, $firstname, $lastname) {
